...
class TransactionsPage {
  ...
  formatDate(date){
    ...
    return `${currentDate.getDate()} ${month[currentDate.getMonth()]} ${currentDate.getHours()}:${currentDate.getMinutes()}`;
  }
  ...
  renderTransactions(data){
    const actTransaction = Array.from(document.querySelectorAll('.transaction'));
    actTransaction.forEach(element => element.remove());
